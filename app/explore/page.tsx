...
export const metadata = {
  ...
  description:
    "Explore, test, and learn from real APIs with our interactive playground. Get code examples, view responses, and understand API endpoints easily.",
    ...
    <div className="p-3 sm:p-4 lg:p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8 lg:mb-12">
          ...
          <h1 className="text-2xl xs:text-3xl sm:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4">
          ...
          <p className="text-muted-foreground text-sm xs:text-base sm:text-lg lg:text-xl mb-4 sm:mb-6 max-w-3xl">
            Discover, test, and learn from real APIs with our interactive playground. Get instant responses, copy-ready
            code examples, and comprehensive documentation - all in one place.
          </p>
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8 lg:mb-12">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="text-center">
              <CardDescription className="text-xs sm:text-sm">
                Get copy-ready code snippets in Node.js, Python, cURL, Ruby, PHP and more programming languages.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow xs:col-span-2 lg:col-span-1">
            ...
            <CardContent className="text-center">
              <CardDescription className="text-xs sm:text-sm">
                View response times, status codes, headers, and beautifully formatted JSON responses instantly.
              </CardDescription>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="mb-6 sm:mb-8">
          <CardHeader>
            ...
            <CardDescription className="text-xs sm:text-sm">
              Follow these simple steps to make the most of LearAPI Explorer
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      Browse through different API categories in the sidebar like Users, Quotes, Products, and Jokes.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      Click on any endpoint to view its documentation, parameters, and example responses.
                    </p>
                  </div>
                </div>
              </div>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      Use the "Try it" button to send real requests and see live responses with timing information.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      Get ready-to-use code snippets in your preferred programming language with one click.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-xs sm:text-sm">
              Everything you need to learn and test APIs effectively
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="text-center">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground">
                  Get instant responses with detailed timing and status information
                </p>
              </div>
              <div className="text-center">
